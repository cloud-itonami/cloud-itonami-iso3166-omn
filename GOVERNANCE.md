...
`cloud-itonami-iso3166-omn` is an OSS open-business blueprint. Governance covers both code and
the operator model.
...
Omani-licensed counsel or a registered agent for whatever licensed
representation the law of Oman requires for public-procurement
filings.
