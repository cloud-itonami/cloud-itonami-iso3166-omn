(ns marketentry.store
  "SSoT for the OMN market-entry compliance actor, behind a `Store`
...
(defn demo-data
  ...
  []
  {:engagements
   {"eng-1" {:id "eng-1" :operator "Kita Systems OM" :portal "Esnad"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-om-entity? true :has-om-entity? true
             :requires-cr? true :cr-verified? true
             :drafted? false :submitted? false
             :jurisdiction "OMN" :status :intake}
    "eng-2" {:id "eng-2" :operator "Atlantis LLC" :portal "Esnad"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-om-entity? true :has-om-entity? true
             :requires-cr? true :cr-verified? true
    ...
    "eng-3" {:id "eng-3" :operator "Minami Systems" :portal "Esnad"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             ...
             :drafted? false :submitted? false
             :jurisdiction "OMN" :status :intake}
    "eng-4" {:id "eng-4" :operator "Higashi Export" :portal "Esnad"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-om-entity? true :has-om-entity? false
             :requires-cr? true :cr-verified? true
             :drafted? false :submitted? false
             :jurisdiction "OMN" :status :intake}
    "eng-5" {:id "eng-5" :operator "Nishi Logistics" :portal "Esnad"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-om-entity? true :has-om-entity? true
             ...
             :drafted? false :submitted? false
             :jurisdiction "OMN" :status :intake}
    "eng-6" {:id "eng-6" :operator "Chuo Civic Tech" :portal "Esnad"
...
(defn- engagement->tx [{:keys [id operator portal base-fee monthly-rate monitoring-months claimed-fee
                               requires-om-entity? has-om-entity?
  ...
  (cond-> {:engagement/id id}
    ...
    (some? requires-om-entity?)  (assoc :engagement/requires-om-entity? requires-om-entity?)
    (some? has-om-entity?)       (assoc :engagement/has-om-entity? has-om-entity?)
...
(def ^:private engagement-pull
  [:engagement/id :engagement/operator :engagement/portal :engagement/base-fee :engagement/monthly-rate
   ...
   :engagement/requires-om-entity? :engagement/has-om-entity?
...
(defn- pull->engagement [m]
  (when (:engagement/id m)
    {:id (:engagement/id m) :operator (:engagement/operator m) :portal (:engagement/portal m)
     ...
     :requires-om-entity? (boolean (:engagement/requires-om-entity? m))
     :has-om-entity? (boolean (:engagement/has-om-entity? m))
